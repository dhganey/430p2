...
paramStruct0.end = 1;
paramStruct0.threadNum = 0;
pthread_create(&threads[0], NULL, func3, (void*) &paramStruct0);
StartEnd paramStruct1;
paramStruct1.start = 1;
paramStruct1.end = 2;
paramStruct1.threadNum = 1;
pthread_create(&threads[1], NULL, func3, (void*) &paramStruct1);
StartEnd paramStruct2;
paramStruct2.start = 2;
paramStruct2.end = 3;
paramStruct2.threadNum = 2;
pthread_create(&threads[2], NULL, func3, (void*) &paramStruct2);
StartEnd paramStruct3;
paramStruct3.start = 3;
paramStruct3.end = 5;
paramStruct3.threadNum = 3;
pthread_create(&threads[3], NULL, func3, (void*) &paramStruct3);
pthread_join(threads[0], NULL);
pthread_join(threads[1], NULL);
pthread_join(threads[2], NULL);
pthread_join(threads[3], NULL);
